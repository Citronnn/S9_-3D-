          ...
          <vgl-renderer class="mainRenderer" antialias
            ...
            <vgl-scene name="mainScene">
              ...
              <vgl-torus-geometry
                  ...
                  radial-segments="15"
              />
              <vgl-mesh material="matTorus" name="torusMeshUp" geometry="torusUp" cast-shadow receive-shadow
              ...
              <vgl-mesh material="matTorus" name="torusMeshDown" geometry="torusDown" cast-shadow receive-shadow
              ...
              <vgl-mesh material="matText" name="textMeshW" geometry="textW" cast-shadow receive-shadow
              ...
              <vgl-mesh material="matText" name="textMeshD" geometry="textD" cast-shadow receive-shadow
